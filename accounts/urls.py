...
urlpatterns = [
    ...
    path('sessions/logout-others/', views.logout_other_devices_view, name='logout_other_devices'),
    ...
    path('users/<int:pk>/toggle-lock/', views.toggle_lock_user_view, name='toggle_lock_user'),
